...
namespace RenderCore {
        ...
        : Name(name), PassInfo(info)
    {
        ...
        //        auto texPtr = reinterpret_cast<RenderGraphTexture*>(inst.Ptr);
        //        if (texPtr) {
        ...
        //        auto srvPtr = reinterpret_cast<RenderGraphTextureSRV*>(inst.Ptr);
        //        if (srvPtr) {
        ...
        //        auto uavPtr = reinterpret_cast<RenderGraphTextureUAV*>(inst.Ptr);
        //        if (uavPtr) {
        ...
        //        auto bufPtr = reinterpret_cast<RenderGraphBuffer*>(inst.Ptr);
        //        if (bufPtr) {
        ...
        //        auto bufSrvPtr = reinterpret_cast<RenderGraphBufferSRV*>(inst.Ptr);
        //        if (bufSrvPtr) {
        ...
        //        auto bufUavPtr = reinterpret_cast<RenderGraphBufferUAV*>(inst.Ptr);
        //        if (bufUavPtr) {
