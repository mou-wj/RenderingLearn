...
void C10LocalIlluminationExample::InitSubPassInfo()
{
	...
	preComputeCodePath.vertexShaderPath = std::string(PROJECT_DIR) + "/src/Examples/RealTimeRendering4/C10LocalIlluminationExamplePrecompute.vert";
	preComputeCodePath.fragmentShaderPath = std::string(PROJECT_DIR) + "/src/Examples/RealTimeRendering4/C10LocalIlluminationExamplePrecompute.frag";
