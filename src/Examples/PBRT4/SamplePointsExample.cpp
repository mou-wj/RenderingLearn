...
void SamplePointsExample::Loop()
{
	...
	while (!WindowEventHandler::WindowShouldClose())
	{
		...
		CmdOpsImageMemoryBarrer(graphicCommandList, textures["image"].image, VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_GENERAL, VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT);
